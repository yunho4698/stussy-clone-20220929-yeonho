package com.stussy.stussyclone20220929yeonho.dto.account;
...
public class RegisterReqDto {
    ...
    @Pattern(regexp = "^(?=.*[a-zA-Z])(?=.*\\d)(?=.*[~!@#$%^&*_])[a-zA-Z\\d~~!@#$%^&*_]{8,16}$", message = "비밀번호는 숫자, 영문(대소문자), 특수기호를 하나 이상 포함하여야하며 8자 이상 16자이하로 작성해야합니다.")
